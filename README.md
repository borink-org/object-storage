...
Currently we only provide the sans-I/O core as a library; you must provide the host yourself. [`hosts/ureq`](https://github.com/borink-org/object-storage/tree/master/hosts/ureq) contains an example host.
