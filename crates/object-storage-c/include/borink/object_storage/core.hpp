...
using AzureBlockOutcome = borink_azure_block_outcome;
using RequestBuffer = borink_request_buffer;
using BlockSource = borink_block_source;
using BlockOptionKind = borink_block_option_kind;
using BlockOption = borink_block_option;
using BlockOptions = borink_block_options;
using StageBlock = borink_stage_block;
...
inline constexpr BlockListKind BlockListKindStaged = BORINK_BLOCK_LIST_KIND_STAGED;
inline constexpr BlockListKind BlockListKindCommitted = BORINK_BLOCK_LIST_KIND_COMMITTED;
inline constexpr BlockListKind BlockListKindAll = BORINK_BLOCK_LIST_KIND_ALL;
inline constexpr BlockState BlockStateStaged = BORINK_BLOCK_STATE_STAGED;
